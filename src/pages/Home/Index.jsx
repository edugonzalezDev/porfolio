...
const projects = [
  {
    nombre: "Bisbier",
    descripcion: "Página web de una cervecería artesanal, desarrollada con React, React Router Dom, Material UI, Firebase",
  ...
  {
    nombre: "Sportit",
    descripcion: "Página web con HTML y CSS, desarrollada con HTML y CSS, con un diseño responsive y animaciones",
  ...
  },
  {
    ...
    descripcion: "API REST desarrollada con Spring Boot, Spring Data JPA, Spring Web, Lombok, H2 Database",
